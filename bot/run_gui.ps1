# Wrapper script to run the GUI app on Windows
# This script prevents sleep and runs the GUI
...
try {
    Write-Host "Starting GUI at $(Get-Date)" -ForegroundColor Cyan
    ...
    Write-Host ""
    Write-Host "GUI exited at $(Get-Date)" -ForegroundColor Cyan
}
